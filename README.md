...
🟢 Pratik 30 - Dizideki Tekrar Eden Çift Sayıları Bulan Program
...
🔵 Ödev 15 - Dizideki Elemanları Sıralama

<details>
	
	    public static void main(String[] args) {
		Scanner input = new Scanner(System.in);
		System.out.print("Diziniz kaç boyutlu? : ");
		int num = input.nextInt();
...
🔵 Ödev 16 - Dizideki Elemanların Frekansı
...
🔵 Ödev 17 - Matris Transpozunu Bulma
